  ...
  return (
    <div className="flex h-full flex-col">
      <header className="flex shrink-0 items-center justify-between px-5 py-3">
        ...
        <span className="font-ja text-[15px] font-bold text-ink">会員登録</span>
      ...
      <main className="no-scrollbar flex-1 overflow-y-auto px-6 pb-10">
        ...
        <button
          onClick={onSubmit}
          disabled={!canSubmit}
          className="mt-5 flex h-[50px] w-full items-center justify-center rounded-md bg-accent text-sm font-extrabold text-on-accent disabled:opacity-40"
        >
          登録する
        </button>
        ...
        <Link
          href="/signin"
          className="mt-5 block text-center font-ja text-[12px] text-muted"
        >
          すでにアカウントをお持ちの方は <span className="font-bold text-accent underline underline-offset-4">ログイン</span>
        </Link>
      </main>
